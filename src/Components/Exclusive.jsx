        ...
        <div className="container mx-auto mt-10">
            <div className="w-11/12 mx-auto bg-[#C2EFD4] px-8 flex justify-between items-center rounded-2xl md:flex-row flex-col">
                ...
                <div className="basis-1/2 space-y-3 md:my-0 my-5">
                    ...
                    <p className="text-myColor font-Poppins md:text-xl text-base">Unlock the ultimate style upgrade with our exclusive offer Enjoy savings of up to 40% off on our latest New Arrivals</p>
                    <CountDown/>
